    ...
    <div className="absolute inset-0 z-50 bg-black/50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button type="button" onClick={onCancel} className="px-4 py-2 text-sm bg-gray-700 hover:bg-gray-600 rounded">
            Cancel
          </button>
          <button type="submit" className="flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black px-4 py-2 rounded font-semibold text-sm">
